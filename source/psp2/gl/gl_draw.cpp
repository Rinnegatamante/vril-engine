...
void Draw_ColoredString (int x, int y, char *text, float r, float g, float b, float a, int scale) { Draw_String(x, y, text); };
void Draw_ColoredStringCentered(int y, char *text, float r, float g, float b, float a, int scale) { Draw_String(20, y, text); };

int getTextWidth(char *str, int scale) { return 20; };
